...
public class NutricaoFragment extends Fragment {
    ...
    public void ViewDesafios(View view){
        try {
            Intent i = new Intent(getActivity(), DesafioNutricaoActivity.class);
            startActivity(i);
        } catch (Exception e) {
            Log.d("exceção", "desafio    " + e);
        }
    }

    public void ViewDieta(View view){
        try {
            Intent i = new Intent(getActivity(), DietaEspActivity.class);
            startActivity(i);
        } catch (Exception e) {
            Log.d("exceção", "desafio    " + e);
        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Button desafios = view.findViewById(R.id.desfio_nutri);
        Button dieta = view.findViewById(R.id.dietaBTN);
